				...
				<div class="carousel-item @if($loop->first) active @endif">
					...
					<div class="carousel-container">
						<div class="carousel-content mx-lg-5">
							...
							@if($banner->button==1)
							@empty($banner->url)
							<a href="javascript:void(0);" class="btn btn-lg btn-outline-light text-uppercase rounded-4 lh-4 py-3 px-3 px-md-5 mx-4 mx-sm-0">{{ $carousel->button_text }}</a>
							@else
							<a href="{{ $banner->pre_url.$banner->url }}" @if($banner->target==2) target="_blank" @endif class="btn btn-lg btn-outline-light text-uppercase rounded-4 lh-4 py-3 px-3 px-md-5 mx-4 mx-sm-0">{{ $banner->button_text }}</a>
							@endempty
							@endif
						</div>
					</div>
...
<section class="ftco-section pt-5 pb-4">
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-6 col-lg-6 col-12">
				<iframe class="w-100 mb-3" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="{{ youtubeUrl($setting->video) }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
		</div>
	</div>
</section>
...
<section class="ftco-section py-5">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-4">
				<div class="card card-implementer rounded-3 shadow">
					<div class="card-body text-center">
						...
						<p class="card-text">{{ $implementer->implementer->title }}</p>
	...
	<div class="container">
		<div class="col-12 text-center pt-5">
			<a href="{{ route('implementers') }}" class="btn btn-lg btn-orange text-white rounded-4 py-3 px-sm-5">View Full Directory</a>
		</div>
	</div>
</section>
...
<section class="ftco-section py-5">
	<div class="container">
		<div class="col-12 heading-section">
			<h2 class="text-blue text-center mb-5">WHY <span class="registered mr-3">EOS</span> WORKS</h2>
		</div>
	</div>
	<div class="container">
		<div class="col-12">
